!(function (e, t) {
  ...
  const h = (function (n) {
    ...
    function we(i) {
      return 1 < i.length
        ? function (e, t, n) {
            for (let r = i.length; r--; ) if (!i[r](e, t, n)) return !1;
            return !0;
          }
        : i[0];
    }
  ...
  (function () {
    ...
    (h.reduce = h.foldl = h.inject = O(1)),
      ...
      (h.find = h.detect = function (n, r, t) {
        const e = (w(n) ? h.findIndex : h.findKey)(n, r, t);
      ...
      (h.every = h.all = function (n, r, t) {
        r = d(r, t);
        for (
          let e = !w(n) && h.keys(n), u = (e || n).length, i = 0;
          i < u;
          i++
        ) {
          const o = e ? e[i] : i;
      ...
      (h.sample = function (n, r, t) {
        ...
        const e = w(n) ? h.clone(n) : h.values(n),
          u = A(e);
        r = Math.max(Math.min(r, u), 0);
        for (let i = u - 1, o = 0; o < r; o++) {
          const a = h.random(o, i),
            c = e[o];
          (e[o] = e[a]), (e[a] = c);
        }
        return e.slice(0, r);
    ...
    var M = function (n, r, t, e) {
      for (let u = (e = e || []).length, i = 0, o = A(n); i < o; i++) {
        ...
        if (w(a) && (h.isArray(a) || h.isArguments(a)))
          if (r) for (let c = 0, l = a.length; c < l; ) e[u++] = a[c++];
    ...
    function F(i) {
      return function (n, r, t) {
        r = d(r, t);
        for (let e = A(n), u = 0 < i ? 0 : e - 1; 0 <= u && u < e; u += i)
    ...
    (h.keys = function (n) {
      ...
      if (a) return a(n);
      const r = [];
      for (const t in n) j(n, t) && r.push(t);
      return I && B(n, r), r;
    }),
      (h.allKeys = function (n) {
        if (!h.isObject(n)) return [];
        const r = [];
        for (const t in n) r.push(t);
        return I && B(n, r), r;
      }),
      (h.values = function (n) {
      ...
      (h.functions = h.methods = function (n) {
        const r = [];
        for (const t in n) h.isFunction(n[t]) && r.push(t);
        return r.sort();
      });
    /**
     * @param c
    ...
    function R(c, l) {
      return function (n) {
        ...
        for (let t = 1; t < r; t++)
          for (
            let e = arguments[t], u = c(e), i = u.length, o = 0;
            o < i;
            o++
          ) {
            const a = u[o];
    ...
    const D = n.document && n.document.childNodes;
    "function" != typeof /./ &&
  ...
  (function (t) {
    ...
    (a.off = function (t, e, i) {
      ...
      (a.stopListening = function (t, e, n) {
        ...
        if (!r) return this;
        for (let s = t ? [t._listenId] : i.keys(r), a = 0; a < s.length; a++) {
          const o = r[s[a]];
          if (!o) break;
    ...
    (a.once = function (t, e, i) {
      const n = u(d, {}, t, e, this.off.bind(this));
      return (
        "string" == typeof t && null == i && (e = void 0), this.on(n, e, i)
      );
    }),
      (a.listenToOnce = function (t, e, i) {
        const n = u(d, {}, e, i, this.stopListening.bind(this, t));
    ...
    const m = (e.Model = function (t, e) {
      ...
      const r = i.result(this, "defaults");
    ...
    i.extend(m.prototype, a, {
      ...
      save: function (t, e, n) {
        ...
        null == t || "object" == typeof t
          ? ((r = t), (n = e))
          : ((r = {})[t] = e);
        const s = (n = i.extend({ validate: !0, parse: !0 }, n)).wait;
        if (r && !s) {
    ...
    const _ = (e.Collection = function (t, e) {
        e || (e = {}),
          this.preinitialize.apply(this, arguments),
    ...
    i.extend(_.prototype, a, {
      ...
      remove: function (t, e) {
        ...
        const n = !i.isArray(t);
        t = n ? [t] : t.slice();
        const r = this._removeModels(t, e);
        return (
          !e.silent &&
            r.length &&
      ...
      set: function (t, e) {
        if (null != t) {
          ...
          for (m = 0; m < t.length; m++) {
            ...
            if (_) {
              if (c && g !== _) {
                let b = this._isModel(g) ? g.attributes : g;
      ...
      fetch: function (t) {
        const e = (t = i.extend({ parse: !0 }, t)).success,
          n = this;
        return (
          (t.success = function (i) {
            const r = t.reset ? "reset" : "set";
            n[r](i, t),
      ...
      _prepareModel: function (t, e) {
        ...
        const n = new ((e = e ? i.clone(e) : {}).collection = this).model(t, e);
      ...
      _removeModels: function (t, e) {
        for (var i = [], n = 0; n < t.length; n++) {
          ...
          if (r) {
            ...
            const a = this.modelId(r.attributes);
      ...
      _onModelEvent: function (t, e, i, n) {
        if (e) {
          ...
          if (("destroy" === t && this.remove(e, n), "change" === t)) {
            const r = this.modelId(e.previousAttributes()),
    ...
    const w = "function" == typeof Symbol && Symbol.iterator;
        ...
        if (this._collection) {
          if (this._index < this._collection.length) {
            ...
            if ((this._index++, this._kind === k)) e = t;
              ...
              const i = this._collection.modelId(t.attributes);
    ...
    i.each(
      ...
      (e.sync = function (t, n, r) {
        ...
        const u = (r.xhr = e.ajax(i.extend(a, r)));
      ...
      route: function (t, n, r) {
        ...
        return (
          e.history.route(t, function (i) {
            const a = s._extractParameters(t, i);
            !1 !== s.execute(r, a, n) &&
    ...
    (e.version = "2.3.7"),
      ...
      (e.TokenSet.prototype.intersect = function (t) {
        for (
          ...
          i = n.pop();
          for (
            let s = Object.keys(i.qNode.edges),
              o = s.length,
...
!(function (typedoc) {
  ...
  const Application = (function (_super) {
    /**
     *
     */
    ...
    !(function (search) {
      ...
      function updateResults() {
        if (
          ...
          for (let i = 0, c = Math.min(10, res.length); i < c; i++) {
            let row = search.data.rows[Number(res[i].ref)],
      ...
      function setCurrentResult(dir) {
        ...
        if (0 == $current.length)
          ...
          const $rel = 1 == dir ? $current.next("li") : $current.prev("li");
          0 < $rel.length &&
